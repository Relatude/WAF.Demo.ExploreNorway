...
public class TripsToNorwayDemo_RegionController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Region> { 
public TripsToNorwayDemo_RegionController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_LocationController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Location> { 
public TripsToNorwayDemo_LocationController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_TouristItemController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.TouristItem> { 
public TripsToNorwayDemo_TouristItemController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_TouristActivityController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.TouristActivity> { 
public TripsToNorwayDemo_TouristActivityController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_TouristAttractionController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.TouristAttraction> { 
public TripsToNorwayDemo_TouristAttractionController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_AccommodationController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Accommodation> { 
public TripsToNorwayDemo_AccommodationController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ShoppingController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Shopping> { 
public TripsToNorwayDemo_ShoppingController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_PlaceToEatOrDrinkController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.PlaceToEatOrDrink> { 
public TripsToNorwayDemo_PlaceToEatOrDrinkController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ArticleController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Article> { 
public TripsToNorwayDemo_ArticleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_SimpleArticleController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.SimpleArticle> { 
public TripsToNorwayDemo_SimpleArticleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_FrontPageController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.FrontPage> { 
public TripsToNorwayDemo_FrontPageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_TouristItemCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.TouristItemCategory> { 
public TripsToNorwayDemo_TouristItemCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ActivityCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ActivityCategory> { 
public TripsToNorwayDemo_ActivityCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_AccommodationCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.AccommodationCategory> { 
public TripsToNorwayDemo_AccommodationCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_AttractionCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.AttractionCategory> { 
public TripsToNorwayDemo_AttractionCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ShoppingCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ShoppingCategory> { 
public TripsToNorwayDemo_ShoppingCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_FoodAndDrinkCategoryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.FoodAndDrinkCategory> { 
public TripsToNorwayDemo_FoodAndDrinkCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ImageGalleryController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ImageGallery> { 
public TripsToNorwayDemo_ImageGalleryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_NewsListController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.NewsList> { 
public TripsToNorwayDemo_NewsListController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_NewsArticleController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.NewsArticle> { 
public TripsToNorwayDemo_NewsArticleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ItemReviewController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ItemReview> { 
public TripsToNorwayDemo_ItemReviewController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_RegisteredUserController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.RegisteredUser> { 
public TripsToNorwayDemo_RegisteredUserController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_RecipeController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.Recipe> { 
public TripsToNorwayDemo_RecipeController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_VacantPositionController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.VacantPosition> { 
public TripsToNorwayDemo_VacantPositionController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_BookProductController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.BookProduct> { 
public TripsToNorwayDemo_BookProductController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_DemoShopController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.DemoShop> { 
public TripsToNorwayDemo_DemoShopController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ControlPanelController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ControlPanel> { 
public TripsToNorwayDemo_ControlPanelController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ModulesPageController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ModulesPage> { 
public TripsToNorwayDemo_ModulesPageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ModuleBaseController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ModuleBase> { 
public TripsToNorwayDemo_ModuleBaseController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ModuleParagraphController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ModuleParagraph> { 
public TripsToNorwayDemo_ModuleParagraphController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ModulePictureSeriesController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ModulePictureSeries> { 
public TripsToNorwayDemo_ModulePictureSeriesController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class TripsToNorwayDemo_ModuleCallToActionController : WAF.Server.Controllers.ContentController<WAF.API.TripsToNorwayDemo.ModuleCallToAction> { 
public TripsToNorwayDemo_ModuleCallToActionController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
