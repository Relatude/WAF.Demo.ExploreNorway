...
public class Country : WAF.API.Native.HierarchicalContent {
public Country(IContentDataProvider dataProvider)
: base(dataProvider) {}
...
: base(dataProvider) {}
        ...
        public WAF.API.TripsToNorwayDemo.Country Country{
        get { return DataProvider.GetPropertyValue(_countryGuid) as WAF.API.TripsToNorwayDemo.Country;}
